...
# ==========================================
MODEL_PATH = r"C:\Users\User\Downloads\indobert_optimal"
...
with tab1:
    ...
    if analyze_btn:
        if user_input.strip() == "":
            ...
            st.info(text_to_predict if text_to_predict else "_(kosong setelah dibersihkan)_")
            ...
            with c2:
                ...
                sorted_labels = [LABEL_MAP[i] for i in range(len(probs))]
                ...
                fig = px.bar(
                    ...
                    y="Probabilitas (%)",
                    color="Sentimen",
                    color_discrete_map={ "Positif":"#2E7D32",
                    "Netral":"#FBC02D",
                    "Negatif":"#C62828"},
                    text_auto='.1f'
                )
